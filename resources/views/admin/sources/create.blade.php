<x-app-layout>
    <x-slot name="title">Thêm nguồn tin — Quản trị VietFeed</x-slot>
    ...
    <div class="container-xl py-4">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <h3 class="mb-0" style="font-family:'Playfair Display',serif;font-size:1.3rem">Thêm nguồn tin mới</h3>
        </div>
                    ...
                    <form action="{{ route('admin.sources.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn-accent" style="padding:.5rem 1.25rem;border-radius:8px;font-size:.875rem;border:none;cursor:pointer">
                                <i class="bi bi-plus-lg me-1"></i>Thêm nguồn tin
                            </button>
